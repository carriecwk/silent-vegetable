...
import * as CernApi from "../../../index.js";
...
export class ImdbClient {
     ...
     *
     * @param {CernApi.CreateMovieRequest} request
     ...
     */
    public createMovie(
        request: CernApi.CreateMovieRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): core.HttpResponsePromise<CernApi.MovieId> {
    ...
    private async __createMovie(
        request: CernApi.CreateMovieRequest,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<CernApi.MovieId>> {
        ...
        if (_response.ok) {
            return { data: _response.body as CernApi.MovieId, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            throw new errors.CernApiError({
     ...
     *
     * @param {CernApi.MovieId} id
     * @param {ImdbClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link CernApi.MovieDoesNotExistError}
     *
     * @example
    ...
    public getMovie(
        id: CernApi.MovieId,
        requestOptions?: ImdbClient.RequestOptions,
    ): core.HttpResponsePromise<CernApi.Movie> {
    ...
    private async __getMovie(
        id: CernApi.MovieId,
        requestOptions?: ImdbClient.RequestOptions,
    ): Promise<core.WithRawResponse<CernApi.Movie>> {
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(this._options?.headers, requestOptions?.headers);
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as CernApi.Movie, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404:
                    throw new CernApi.MovieDoesNotExistError(
                        _response.error.body as CernApi.MovieId,
